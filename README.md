...
| `POST` | `/auth/verify`     | No   | Verify OTP and receive tokens     |
| `GET`  | `/wallets`         | Yes  | Get wallet balances               |
| `POST` | `/wallets/fund`    | Yes  | Fund wallet                       |
| `POST` | `/wallets/convert` | Yes  | Convert between currencies        |
| `POST` | `/wallets/trade`   | Yes  | Trade currencies                  |
| `GET`  | `/fx/rates`        | Yes  | Get current FX rates              |
| `GET`  | `/transactions`    | Yes  | Get paginated transaction history |
